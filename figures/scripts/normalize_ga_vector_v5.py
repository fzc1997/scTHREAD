#!/usr/bin/env python3
"""Remove volatile SVG/PDF metadata from graphical abstract v5 exports."""
...
FIXED_PDF_DATE = "D:20260727103839+08'00'"
FIXED_PDF_ID = bytes.fromhex("5271d2641cef74fa8a25e00655858466")
...
def normalize_pdf(path: Path) -> None:
    ...
    writer.add_metadata(
        {
            "/Title": "scTHREAD graphical abstract v5",
