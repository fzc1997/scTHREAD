#!/usr/bin/env python3
"""Remove volatile SVG/PDF metadata from graphical abstract v7 exports."""
...
FIXED_PDF_DATE = "D:20260727150000+08'00'"
FIXED_PDF_ID = bytes.fromhex("87072635a9b64874a64e48a72ad84ab7")
...
def normalize_pdf(path: Path) -> None:
    ...
    writer.add_metadata(
        {
            "/Title": "scTHREAD graphical abstract v7",
