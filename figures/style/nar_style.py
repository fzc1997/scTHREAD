...
ROOT = REPO  # figure scripts resolve the repository through this alias
FIGDATA = REPO / "source_data" / "catalog_figdata"
F2DATA = REPO / "source_data" / "f2_grammar_figdata"
OUTDIR = Path(os.environ.get("SCTHREAD_FIGURE_OUTPUT", str(REPO / "figures" / "output")))

_ARIAL = Path(os.environ["SCTHREAD_FONT"]) if os.environ.get("SCTHREAD_FONT") else None
if _ARIAL and _ARIAL.exists():
