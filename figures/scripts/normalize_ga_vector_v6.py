#!/usr/bin/env python3
"""Remove volatile SVG/PDF metadata from graphical abstract v6 exports."""
...
FIXED_PDF_DATE = "D:20260727113537+08'00'"
FIXED_PDF_ID = bytes.fromhex("b8d47d4716c1c40ce294fd346f13b563")
...
def normalize_pdf(path: Path) -> None:
    ...
    writer.add_metadata(
        {
            "/Title": "scTHREAD graphical abstract v6",
