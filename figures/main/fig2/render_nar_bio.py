...
ASSETS = REPO / "figures" / "assets"
REG = Path(os.environ.get("SCTHREAD_SCLONG_ROOT", str(REPO))) / "source_data" / "tables" / "sample_registry_frozen_20260914.tsv"
P0DATA = REPO / "source_data" / "biological_unit_validation"
...
SNAPSHOT_MANIFEST = REPO / "database" / "frozen_release" / "release_manifest.tsv"
...
def render_fig1(stem: str = "NAR_Fig1"):
    ...
    if n_layer:
        ...
        cov_sum_path = REPO / "source_data" / "tables" / "fig1_layer_coverage_summary.tsv"
...
def render_fig3(stem: str = "NAR_Fig3"):
    ...
    api_ov = REPO / "source_data" / "tables" / "PTPRC_api_overview.json"
    api_note = ""
    if api_ov.exists():
        try:
