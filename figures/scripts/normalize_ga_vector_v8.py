#!/usr/bin/env python3
"""Remove volatile SVG/PDF metadata from graphical abstract v8 exports."""
...
FIXED_PDF_DATE = "D:20260728090000+08'00'"
FIXED_PDF_ID = bytes.fromhex("c2e2c534a66b4e08bd86fd0e8f67e308")
...
def normalize_pdf(path: Path) -> None:
    ...
    writer.add_metadata(
        {
            "/Title": "scTHREAD graphical abstract v8",
